...
(
    ...
    '2026-07-31',            -- ddate 报表日期，7月月报取当月最后一天
    1,                       -- xh 序号，手动插入填1
...
(
    ...
    '2026-07-31',                  -- ddate 报表日期，7月月报月末
    '海南正堂-富邦华一',           -- project_name 项目名称
    '2026-07-01',                  -- loan_date 放款日期，取担保起始日
    'HT-FTBHY-202607001',          -- cont_no 合同编号【主键，务必唯一，冲突就换号】
    'HT-FTBHY-202607001',          -- biz_no 业务编号，脚本逻辑：同cont_no
    'FTBHY001',                    -- cust_id 和G11插入的客户编号严格对应
    '富邦华一银行有限公司',        -- cust_name客户名称
    'A0101',                       -- guar_type 担保类型，和脚本默认A0101
    'A',                           -- biz_mode 业务开展方式，脚本默认A
    92040991.84,                   -- guar_amt 担保金额
    NULL,                          -- loan_rate 贷款利率无数据
    0.002000,                      -- guar_rate 担保费率，脚本默认兜底0.2
    '2026-07-01',                  -- guar_start 担保起始日期
    '2027-07-01',                  -- guar_end 担保到期日期
...
(
    ...
    '2026-07-31',                  -- ddate 报表日期，和G23保持7月月报月末
    1,                             -- xh 序号
    'HT-FTBHY-202607001',          -- cont_no 【必须和G23_detail的cont_no完全一致，联合主键】
    'HT-FTBHY-202607001',          -- biz_no 业务编号，同G23
    '海南正堂-富邦华一',           -- project_name 项目名称
...
(
    ...
    '2026-07-31',                   -- ddate 报表日期7月月末
    'HT-FTBHY-202607001',           -- cont_no 必须和G23_detail完全一致
    'HT-FTBHY-202607001',           -- biz_no 业务编号
    '海南正堂-富邦华一',            -- project_name项目名称
    'A',                            -- comp_type 代偿类型，脚本写死A
    'COMP-FTBHY-20260729001',       -- comp_seq 代偿流水号，唯一，冲突就换
    '2026-07-29',                   -- comp_date 实际代偿日期
    8748889.70,                     -- comp_amt 代偿本金
...
(
    ...
    '2026-07-31',                   -- ddate 7月月报
    1,                              -- xh 序号
    '海南正堂-富邦华一',            -- project_name
    'HT-FTBHY-202607001',           -- cont_no 和G23/G27保持一致
    'HT-FTBHY-202607001',           -- biz_no
    'COMP-FTBHY-20260729001',       -- recv_seq 复用G27的comp_seq
    '2026-07-30',                   -- recv_date 代偿日期+1天，对齐源脚本case逻辑
    8748889.70,                     -- recv_amt 代偿总金额（本金+利息）
    CURRENT_TIMESTAMP,
    CURRENT_TIMESTAMP
);